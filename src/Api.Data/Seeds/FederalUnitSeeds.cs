...
{
    public static class FederalUnitSeeds
    {
        public static void FederalUnits(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<FederalUnitEntity>().HasData(
            new FederalUnitEntity()
                {
